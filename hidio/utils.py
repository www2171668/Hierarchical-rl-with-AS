...
def compute_discount_from_horizon(T, num_episodes=1):
    """For an MDP with an infinite horizon and a time limit :math:`T` for each episode,
    compute the discount factor as :math:`1-\frac{1}{T}`.
    This function is mainly used by gin files.
