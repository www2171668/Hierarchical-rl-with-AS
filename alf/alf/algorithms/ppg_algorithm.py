...
class PPGAlgorithm(OffPolicyAlgorithm):
    ...
    def predict_step(self, inputs: TimeStep, state):
        return ppg_network_forward(self._network, inputs, state, self._predict_step_epsilon_greedy)
    ...
    def after_train_iter(self, experience, info: PPGTrainInfo):
        ...
        if alf.summary.get_global_counter() % self._aux_algorithm.interval == 0:
            self._aux_algorithm.train_from_replay_buffer(update_global_counter=False)
